...
const Cart = () => {
    ...
    return (
        <>
            <div className="my-5">
                {products.length === 0 ?
                    <div className="container background-color rounded py-3">
                    ...
                    <div className="container">
                        {products.map((product) => (
                            <div className="item-cart container rounded" key={product.id}>
                        ...
                        <div>
                            <h3 className="d-flex justify-content-end total background-color rounded">Total: $ {totalCompra}</h3>
